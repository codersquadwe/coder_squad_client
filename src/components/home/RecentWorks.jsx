...
const RecentWorks = () => {
    return (
        <div className="lg:md:ps-[10.5rem] mx-auto my-auto lg:md:mt-[15rem] mt-20 lg:md:px-6 px-4">
            <div>
                ...
                <div className="grid lg:md:grid-cols-3 grid-cols-2 gap-y-4 overflow-auto justify-center gap-x-4 ">
                ...
                <Link href="/projects" className="text-[#27D294] lg:md:text-2xl text-[16px] text-end w-full flex justify-end mt-10">See more</Link>
            </div>
        </div>
    );
};
