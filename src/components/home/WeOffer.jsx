...
const WeOffer = () => {
    return (
        <div className="max-w-[1500px] lg:md:px-8 px-4 mx-auto my-auto lg:md:mt-[15rem] mt-20">
            <div>
                <h2 className="text-[#FCFCFD] text-center text-5xl font-semibold leading-[48px] mb-2">Don’t sell your brand short. We can help.</h2>
                ...
                <div className="lg:md:mt-28 grid grid-cols-2 items-center justify-between w-full gap-x-16">
                    ...
                    <div>
                    <h2 className="lg:md:text-5xl font-bold text-[#eee]">Full-stack, full-service BigCommerce agency</h2>
